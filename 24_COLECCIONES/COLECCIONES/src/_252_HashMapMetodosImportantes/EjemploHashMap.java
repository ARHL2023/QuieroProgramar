package _252_HashMapMetodosImportantes;
...
public class EjemploHashMap {
    public static void main(String[] args) {
        ...
        //CONTAINS, PARA BUSCAR
        boolean buscaConEdad = persona.containsKey("Edad");//true
        System.out.println("buscaConEdad = " + buscaConEdad + "");

//        //ELIMINAR
//        String edadEliminada = persona.remove("Edad");
//        System.out.println("edadEliminada = " + edadEliminada);
